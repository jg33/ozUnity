Shader "Particle Dissolve/Softrim/Opacity/Soft Alpha Blended" 
{
Properties {
	...
	SubShader {
		Pass {
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed sf2 = smoothstep(0,(1-tex.a),i.color.a);
				return fixed4(tex.rgb*i.color.rgb,tex.a*sf2*_Opacity);
			}
			ENDCG 
		}
	}	

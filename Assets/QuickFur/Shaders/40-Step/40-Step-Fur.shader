Shader "QuickFur/40 Step/Diffuse" 
{
	Properties 
    {
	...
	SubShader 
    {
            ...
            UsePass "Hidden/FurBase/LAYER1.5"
            UsePass "Hidden/FurBase/LAYER2"
            UsePass "Hidden/FurBase/LAYER2.5"
            UsePass "Hidden/FurBase/LAYER3"
            UsePass "Hidden/FurBase/LAYER3.5"
            UsePass "Hidden/FurBase/LAYER4"
            UsePass "Hidden/FurBase/LAYER4.5"
            UsePass "Hidden/FurBase/LAYER5"
            UsePass "Hidden/FurBase/LAYER5.5"
            UsePass "Hidden/FurBase/LAYER6"
            UsePass "Hidden/FurBase/LAYER6.5"
            UsePass "Hidden/FurBase/LAYER7"
            UsePass "Hidden/FurBase/LAYER7.5"
            UsePass "Hidden/FurBase/LAYER8"
            UsePass "Hidden/FurBase/LAYER8.5"
            UsePass "Hidden/FurBase/LAYER9"
            UsePass "Hidden/FurBase/LAYER9.5"
            UsePass "Hidden/FurBase/LAYER10"
            UsePass "Hidden/FurBase/LAYER10.5"
            UsePass "Hidden/FurBase/LAYER11"
            UsePass "Hidden/FurBase/LAYER11.5"
            UsePass "Hidden/FurBase/LAYER12"
            UsePass "Hidden/FurBase/LAYER12.5"
            UsePass "Hidden/FurBase/LAYER13"
            UsePass "Hidden/FurBase/LAYER13.5"
            UsePass "Hidden/FurBase/LAYER14"
            UsePass "Hidden/FurBase/LAYER14.5"
            UsePass "Hidden/FurBase/LAYER15"
            UsePass "Hidden/FurBase/LAYER15.5"
            UsePass "Hidden/FurBase/LAYER16"
            UsePass "Hidden/FurBase/LAYER16.5"
            UsePass "Hidden/FurBase/LAYER17"
            UsePass "Hidden/FurBase/LAYER17.5"
            UsePass "Hidden/FurBase/LAYER18"
            UsePass "Hidden/FurBase/LAYER18.5"
            UsePass "Hidden/FurBase/LAYER19"
            UsePass "Hidden/FurBase/LAYER19.5"
            UsePass "Hidden/FurBase/LAYER20"
            UsePass "Hidden/FurBase/LAYER20.5"
	}

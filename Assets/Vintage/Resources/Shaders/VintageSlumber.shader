///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// \brief   Vintage - Slumber.
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Copyright (c) Ibuprogames. All rights reserved.
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

// http://unity3d.com/support/documentation/Components/SL-Shader.html
Shader "Hidden/Vintage/Slumber"
{
  ...
  Properties
  {
    ...
    // Default 'Resources/Textures/SlumberLut.png'.
  ...
  float4 frag_gamma(v2f_img i) : COLOR
  {
	...
	float3 final = tex3D(_LutTex, (pixel.rgb * _Scale) + _Offset).rgb;
  ...
  SubShader
  {
    ...
    {
      CGPROGRAM
	  #pragma exclude_renderers gles // No sampler3D support in OpenGL ES 2.
